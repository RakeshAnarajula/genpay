...
const FeatureCard = ({ icon, title, description }) => (
  <div className="bg-white p-6 rounded-lg shadow-md text-center transition duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-lg">
...
const BenefitCard = ({ icon, title, description }) => (
  <div className="bg-white p-6 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-lg">
...
const Teens = () => {
  ...
  <section className="text-center mb-16 py-20">
    ...
    <div className="flex flex-col lg:flex-row justify-center space-y-20 p-5 lg:space-y-0 lg:space-x-5">
