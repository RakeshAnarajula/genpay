  ...
  return (
    <section id="home" className="py-20 px-6">
      <div className="container mx-auto flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 pl-8 py-5" data-aos="fade-left" data-aos-duration="1000">
          <AnimatedContent>
            <img
              src="/image2.jpg"
...
const AICardSection = () => {
  return (
    <section className="bg-green-50 px-6">
      <div className="container mx-auto flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 mb-10 md:mb-0 pb-20" data-aos="fade-right" data-aos-duration="1000">
          <AnimatedContent>
            <img
              src="/image3.jpg"
              alt="GenZPay Card"
...
const FeatureCard = ({ icon, title, description, imgSrc }) => {
  ...
  return (
    <AnimatedContent>
      <div
        onClick={handleClick}
        className="bg-white shadow-md rounded-lg p-6 text-center transition-all duration-300 ease-in-out hover:shadow-xl cursor-pointer"
        data-aos="zoom-in"
...
const Footer = () => {
  return (
    <footer className="bg-gray-700 text-white py-12 pl-2">
